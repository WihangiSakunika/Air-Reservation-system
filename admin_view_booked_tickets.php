...
{
  background: linear-gradient(315deg, #F0550D, white)
}
...
.container .box .content a:hover
{
  ...
  <div class="box">
    <span></span>
    <div class="content">
      <h2 style="font-family: 'Montserrat', sans-serif;color:#041C1C;text-align: center;">BOOKED TICKETS</h2>
     ...
     <div>
		<form action="admin_view_booked_tickets_form_handler.php" method="post">
			...
			<table cellpadding="5">
				<tr>
					<td class="fix_table" style="font-family: 'Montserrat', sans-serif;">Enter the Flight No.</td>
					
				</tr>

				<tr>
					<td class="fix_table"><input style="border:none;font-family: 'Montserrat', sans-serif; margin-left: 100px;width: 500px;" type="text" name="flight_no" required></td>
					
				</tr>
				<tr>
					<td style="font-family: 'Montserrat', sans-serif;" class="fix_table">Enter the Departure Date</td>
					
				</tr>
				<tr>
					<td class="fix_table"><input style="border:none;font-family: 'Montserrat', sans-serif;margin-left: 100px;width: 500px;" type="date" name="departure_date" required></td>
				</tr>
			</table>
			<br>
			<br>
			<input style="font-family: 'Montserrat', sans-serif;width: 200px;background-color: #24a0ed;border:none;margin-left: 200px;width: 320px;" type="submit" value="Submit" name="Submit">
			</div>
		</form>
