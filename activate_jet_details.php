...
input{
  ...
  <div class="box">
    <span></span>
    <div class="content">
      <h2 style="font-family: 'Montserrat', sans-serif;color:#041C1C;text-align: center;">FLIGHT NUMBER</h2>
     ...
     <div>
		...
		<form action="activate_jet_details_form_handler.php" method="post">
			...
			<?php
				...
				{
					echo "<strong style='color: green'>Activated !</strong>
						<br>
						<br>";
				}
				else if(isset($_GET['msg']) && $_GET['msg']=='failed')
				{
					echo "<strong style='color:red'>Invalid Jet ID entered, please enter correct one</strong>
						<br>
						<br>";
				}
			?>
			<table cellpadding="5" style="padding-left: 20px;">
				<tr>
					<td class="fix_table">Whats is your flight number ?</td>
				</tr>
				<tr>
					<td class="fix_table"><input style="width: 400px;margin-left: 100px;" type="text" name="jet_id" required></td>
				</tr>
			</table>
			<br>
			<input style="font-family: 'Montserrat', sans-serif;width: 200px;background-color: #24a0ed;border:none;margin-left: 170px;width: 320px;height: 40px;cursor: pointer;" type="submit" value="Activate" name="Activate">
      <br><br>
      <a style="margin-left:230px" href="add_flight_details.php">add flight scedule</a>
			</div>
		</form>
		</div>
