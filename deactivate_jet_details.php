...
td{
  ...
  <div class="box">
    <span></span>
    <div class="content">
      <h2 style="font-family: 'Montserrat', sans-serif;color:#041C1C;text-align: center;">FLIGHT IS READY TO BE DEACTIVATED</h2>
     ...
     <div>
		...
		<form action="deactivate_jet_details_form_handler.php" method="post">
			...
			<?php
				...
				{
					echo "<strong style='color: white;'>The flight number that you entered is Deactivated a moment ago !</strong>
						<br>
						<br>";
				}
				else if(isset($_GET['msg']) && $_GET['msg']=='failed')
				{
					echo "<strong style='color:red'>Something went wrong ! try again</strong>
						<br>
						<br>";
				}
			?>
			<table cellpadding="5" style="padding-left: 20px;">
				...
				<tr>
					<td class="fix_table"><input style="width: 400px;margin-left: 100px;font-family: 'Montserrat', sans-serif;" type="text" name="jet_id" required></td>
				</tr>
			</table>
			<br>
			<input style="font-family: 'Montserrat', sans-serif;width: 200px;background-color: #24a0ed;border:none;margin-left: 170px;width: 320px;height: 40px;cursor: pointer;" type="submit" value="Deactivate" name="Deactivate">
			</div>
		</form>
		</div>
