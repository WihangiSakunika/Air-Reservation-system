...
<center><img src='images/.jpg' class='img-thumbnail' width='00px' style='height:0px;'></center>";
                   ...
                   <?php
                    ...
                    while($row1 = mysqli_fetch_array($result1))
                      {                  
                        ...
                        echo "<center><img src='images/.jpg' class='img-thumbnail' width='180px' style='height:180px;'></center>";
                        echo"<div>";
                      }
                   ?>
                        </td>
