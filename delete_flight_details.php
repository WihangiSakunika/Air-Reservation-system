...
<html>
	<head>
		<title>
			Delete Flight Schedule Details | ARS
		</title>
...
{
  background: linear-gradient(315deg, transparent, white)
}
...
input{
  ...
  <div class="box">
    <span></span>
    <div class="content">
      <h2 style="font-family: 'Montserrat', sans-serif;color:#041C1C;text-align: center;">FLIGHT SCHEDULE TO BE DELETED</h2>
     ...
     <div>
		...
		<form action="delete_flight_details_form_handler.php" method="post">
			...
			<?php
				...
				{
					echo "<strong style='color:white;font-family: 'Montserrat', sans-serif;border:1px solid white; padding-left:20px;'>The Flight Schedule you entered deleted a moment ago !</strong>
						<br>
						<br>";
				}
			...
			<table cellpadding="5" style="padding-left: 20px;">
				...
				<tr>
					<td class="fix_table"><input style="border:none;width: 360px;" type="text" name="flight_no" required></td>
					<td class="fix_table"><input style="border:none;width: 360px;" type="date" name="departure_date" required></td>
				</tr>
			</table>
			<br>
			<br>
			<input style="font-family: 'Montserrat', sans-serif;width: 200px;background-color: #24a0ed;border:none;margin-left: 250px;width: 320px;height: 40px;cursor: pointer;" type="submit" value="Delete" name="Delete">
			</div>
		</form>
